...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\my_projects\EmiratiDeals\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\windows\\my_projects\\EmiratiDeals\\public\\storage',
...
'signed','throttle','verified','admin','redirectAdmin',);
...
'profile.edit','profile.update','profile.destroy','admin.login','admin.login.post',
'admin.logout','admin.dashboard','register','login','password.request','password.email','password.reset','password.store',
